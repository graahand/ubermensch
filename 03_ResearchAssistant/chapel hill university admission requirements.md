...
2. Thesis advisor can be selected by student themselves for MS degree as well. 
3. student service manager (kenney@cs.unc.edu) will handle the CS Forms and graduate forms and forward them to appropriate department. 
4. 30 credits masters with thesis, alongw ith outside of the computer science (like stats for AI)
5. transcript is required to see whether my bachelor's result satisfy the academic  requirements for getting admission in Masters (stats, data structure, linear algebra, operating systems, programming conepts are some of the major one)
6. link to master's in computer science (https://cs.unc.edu/graduate/ms/)
7. university recommended application submission date is no later than **November 26**.
